          ...
          <!-- Login -->
            <section>
              <div class="bloque-info-sup">
                ...
                // echo "el valor es:.".$user->uid.".";
                if($user->uid==0){?>
                  <button class="btn-estilos-v1" id="btn_ingreso_tiendas">Ingreso para tiendas</button>
                  <form action="/user" method="post" id="user-login" accept-charset="UTF-8">
                    <div>
                      <span class="subtitulo iniciar" style="margin-top:8px;">Iniciar sesión</span>
                      <input type="text" id="edit-name" name="name" value="" size="60" maxlength="60" class="form-text required" placeholder="Correo electronico">
                      <input type="password" id="edit-pass" name="pass" size="60" maxlength="128" class="form-text required" placeholder="Contraseña">
                      <input type="hidden" name="form_build_id" value="form-CadJw_ukYqde4rioTac54jAdda1dG41w5uMrmu-tO94">
                      <input type="hidden" name="form_id" value="user_login">
                      <div class="form-actions form-wrapper" id="edit-actions">
                      <input type="submit" id="edit-submit" name="op" value="Ingresar" class="form-submit btn-estilos-v1" style="margin: 0px 10px 0 5px;"></div>
                      <script>
                  ...
                  // print_r($user);
                  // echo "</pre>";
                  echo '<a href="/user/logout" id="btnsalir" class="btn-estilos-v1">Salir</a>';
                  echo '<a href="/node/add/galeria" id="btnsalir" class="btn-estilos-v1"><b>+</b> Agregar galeria</a>';
                  echo '<a href="/node/add/productos" id="btnsalir" class="btn-estilos-v1"><b>+</b> Agregar producto</a>';
                }?>
              </div>
            </section>
          <!-- fin Login -->
